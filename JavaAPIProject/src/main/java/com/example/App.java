...
public class App {
    public static void main(String[] args) {
        ...
        try {
            ...
            String output = API.getData("https://api.igdb.com/v4/games", bearerCode, clientId, "fields name, genres.*, game_engines.*, involved_companies.*, platforms.*, game_type, summary; where genres != null & game_engines != null & involved_companies != null & platforms != null & summary != null; limit 2;");
            ...
            for (int i = 0; i < gameArray.length(); i ++) {
                ...
                for (int j = 0; j < platforms.length(); j ++) {
                    ...
                    platformName.add(k.getString("abbreviation"));
                }
